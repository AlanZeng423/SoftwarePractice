 ...
 */
@WebServlet("/")//表明任意Servlet请求路径都交给DispatcherServlet处理
public class DispatcherServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws
        ...
        //对请求和响应的字符集的限制，均为UTF-8；且响应的内容未JSON格式
        ...
        //映射方法为：http://localhost:8080/elm/Controller类名/Controller方法名
        //className是Controller类名
        //methodName是Controller方法名
